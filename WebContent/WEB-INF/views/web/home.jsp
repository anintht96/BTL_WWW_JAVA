...
<body>
	...
	<div class="container">
		...
		<div class="row align-items-center my-5">
			<div class="col-lg-7">
				<img class="img-fluid rounded mb-4 mb-lg-0"
					src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRcVnwB9Ol9bS7qx-aLoCp0Zt20ogcDnAwjVA&usqp=CAU" alt="">
			</div>
			<!-- /.col-lg-8 -->
			<div class="col-lg-5">
				<h1 class="font-weight-light">Web bán hàng online</h1>
				<p></p>
			</div>
			<!-- /.col-md-4 -->
		</div>
		...
		<div class="card text-white bg-secondary my-5 py-4 text-center">
			<div class="card-body">
				<p class="text-white m-0"><img alt="" src="https://lh3.googleusercontent.com/proxy/nMmcj_4Hdxtp-9h866SR09f_UW2MOMtWWP4AzKiSW0lZHOvHqeBebqBr8FfpvG07NsyvmV5r1DIY009vQYFt53PPoa6oPRKztpk0_TyihOAQ980HwH_0HQcCrYuOwu-4HTskYov2kOnV6brOCeK-WqR-nVuhIonZ35shd4xdif_wGcZtxw"></p>
			</div>
		</div>
